...
• Поддержка банковских карт, электронных кошельков и других способов
• Интеграция прямо в сайт — без скрытых комиссий и сложных настроек
...
def is_offer_request(text: str) -> bool:
    """Проверяет, есть ли в тексте триггеры на оферту."""
